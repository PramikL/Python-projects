...
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACE_HEIGHT)),90)

RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets','spaceship_red.png'))

RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACE_HEIGHT)),270)
...
def yellow_spaceship_movement_control(keys_pressed,yellow):
    ...
    if keys_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x: #moves the spaceship right
            yellow.x += VEL
        
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0: #moves the spaceship up
            yellow.y -= VEL
            
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height < HEIGHT - 20: #moves the spaceship down
            yellow.y += VEL
